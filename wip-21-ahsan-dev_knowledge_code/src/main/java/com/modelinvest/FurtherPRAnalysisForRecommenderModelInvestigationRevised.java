...
public class FurtherPRAnalysisForRecommenderModelInvestigationRevised {

    public String scratchDataLocBackup = "/home/local/SAIL/ahsan/dev_knowledge/scratch_dev_ku_data/Result/";
    public String modelScorePath = "/home/local/SAIL/ahsan/BACKUP/ahsan_project_2021/ahsan_gustavo/dev_knowledge/Result_June_26_2022/Review_Recommendation_Restult/per_dev_score_Dec_9_2022/";
    ...
    public void studyReviewerRankMissing(int topRank, List<String>investModels){
        ...
        String path = "/home/local/SAIL/ahsan/BACKUP/ahsan_project_2021/ahsan_gustavo/dev_knowledge/Result_June_26_2022/Review_Recommendation_Restult/per_dev_score_Dec_9_2022/";
        ...
        try{
            ...
            int problem = 0;
            for(String modelName : investModels){
                String filePath = String.format("%s/InCorrectReviewerRankingResult/%s_FULL_top_rank%s.csv",path, modelName, topRank);  
    ...
    public static void main(String[] args) throws Exception{
        FurtherPRAnalysisForRecommenderModelInvestigationRevised ob = new FurtherPRAnalysisForRecommenderModelInvestigationRevised();
        ob.studyNewFilesInPRTesting();
